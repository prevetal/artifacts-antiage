document.addEventListener('DOMContentLoaded', function() {
	// Sunscreen cosmetics with us slider
	const sunscreenCosmeticsWithUsSliders = [],
		sunscreenCosmeticsWithUs = document.querySelectorAll('.sunscreen_cosmetics_with_us .swiper')

	sunscreenCosmeticsWithUs.forEach((el, i) => {
		el.classList.add('sunscreen_cosmetics_with_us_s' + i)
		...
		sunscreenCosmeticsWithUsSliders.push(new Swiper('.sunscreen_cosmetics_with_us_s' + i, options))
	})
